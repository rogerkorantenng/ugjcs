...
<dl class="docmeta">
  ...
  <dd>2026-08-14</dd>
  <dt>Status</dt>
  <dd>Authoritative. This document is the single source of truth for the HTTP boundary between the FastAPI backend and the Next.js frontend. Where any other document's prose disagrees with this one, this document wins; the disagreement is a defect there, to be corrected there, not here.</dd>
</dl>
