...
<dl class="docmeta">
  ...
  <dd>2026-08-12</dd>
  <dt>Status</dt>
  <dd>Authoritative. Every figure in this document was produced by running the commands it cites — <code>make check</code>, <code>make integration</code>, and a live session against the deployed frontend — on 2026-08-12, and is reproducible by running the same commands against the same commit. Where a figure could not be produced this way, that is stated rather than estimated.</dd>
</dl>
