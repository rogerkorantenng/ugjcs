 ...
 */
export const QUEUE_SECTIONS: { status: ManuscriptStatus; title: string; hint: string }[] = [
  { status: "submitted", title: "Awaiting screening", hint: "Begin screening a new submission." },
  { status: "under_screening", title: "In screening", hint: "Assign a reviewer, desk reject, or send to review." },
  { status: "under_review", title: "Under review", hint: "Waiting on reviewers — no editorial action needed yet." },
  { status: "reviews_complete", title: "Reviews complete", hint: "Reviews are in; a decision is needed." },
  { status: "revision_requested", title: "Revision requested", hint: "Waiting on the author to resubmit." },
  { status: "resubmitted", title: "Resubmitted", hint: "The author has resubmitted — screen it or send it back to review." },
  { status: "accepted", title: "Accepted", hint: "Ready for the Editor-in-Chief to schedule into an issue." },
];

/** One status grouping of the editorial queue: heading, hint, and the manuscripts table.
 * Under-review rows additionally mount a lazy `ReviewOverdueChip`, which fetches that
 * manuscript's assignments and seals the row when any review is past its deadline. */
